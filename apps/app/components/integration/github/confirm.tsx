...
export const GithubConfirm: FC<Props> = ({ state, handleState }) => (
  <div className="space-y-5">
    <div className="min-h-[200px] space-y-8 py-5">
      <div className="font-medium">Confirming Migration</div>

      <div className="flex items-center gap-2">
        <div className="w-full space-y-1">
          <div className="font-medium">Migrating</div>
        </div>
      ...
      <div className="flex items-center gap-2">
        <div className="w-full space-y-1">
          <div className="font-medium">Skipping</div>
        </div>
        <div className="flex w-full items-center gap-2">
          <div className="w-full space-y-1 text-center">
            <div className="text-xl font-medium">0</div>
